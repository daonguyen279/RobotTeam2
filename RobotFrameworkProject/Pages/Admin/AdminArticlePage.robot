...
${lnk_articles_icon_unpublish}    xpath=//table[@id="articleList"]//tr[td//a[contains(text(),"xCfdQfJzSObGKMkxYItRdjlAjJKcRc")]]/td[count(//table[@id="articleList"]//tr/th[a[@data-name="Status"]]/preceding-sibling::th)+1]/div[@class="btn-group"]/a/span[@class="icon-unpublish"]
