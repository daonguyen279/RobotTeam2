...
${cbk_menus_parent}             xpath=//div[@id="jform_menutype_chzn"]/a/div/b
...
Check Add New Menu Successfully
    ...
    ${xpath_menus_title}    Format String    ${xph_menus_title}      ${arg_menu_title}
    Element Should Be Visible                ${xpath_menus_title}    
...
Delete Menu
    ...
    ${xpath_menus_checkbox}    Format String    &{xph_menus_checkbox}      ${arg_menu_to_delete}
    Click Element                               ${xpath_menus_checkbox}    
...
Check Delete Menu Successfully
    [Arguments]                              ${arg_menu_title}
    ${xpath_menus_title}    Format String    ${xph_menus_title}      ${arg_menu_title}
    Page Should Not Contain Element          ${xpath_menus_title}    
...
Fill Out And Submit Menu Item Information
    ...
    ${xpath_menuitems_type}          Format String                 ${xph_menuitems_type}       ${arg_menuitem_type} 
    ${xpath_submenuitems_type}       Format String                 ${xph_submenuitems_type}    ${arg_submenuitem_type}        
    ${xpath_menus_parent}            Format String                 ${xph_menus_parent}         ${arg_menu_parent}    
    Input Text                       ${txt_menuitems_title}        ${arg_menuitem_title}    
    Click Element 	                 ${btn_menuitems_type}
    Select Frame                     ${frm_menus}               
    Click Element                    ${xpath_menuitems_type}
    Wait Until Element Is Visible    ${xpath_submenuitems_type}       
    Click Element                    ${xpath_submenuitems_type}  
    Unselect Frame  
    Click Element                    ${cbk_menus_parent}
    Wait Until Element Is Visible    ${xpath_menus_parent}
    Click Element                    ${xpath_menus_parent}                                  
    Click Element                    ${btn_menus_save_close}      
	
Delete Menu Item
    [Arguments]                    ${arg_menuitem_title}
    ${xpath_menuitems_checkbox}    Format String                  ${xph_menuitems_checkbox}    ${arg_menuitem_title}
    Click Element                  ${xpath_menuitems_checkbox}        
