...
*** Variables ***
${txt_update_name}                xpath=//form[@id="profile-form"]//input[@id="jform_name"]
${txt_update_password}            xpath=//form[@id="profile-form"]//input[@id="jform_password2"]
${txt_update_confirm_password}    xpath=//form[@id="profile-form"]//input[@id="jform_password"]
${txt_update_email}               xpath=//form[@id="profile-form"]//input[@id="jform_email"]
