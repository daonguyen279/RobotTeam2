...
*** Variables ***
${arg_title_categories}          This is the first tittle, which have added for 2 minutesfggfd
...
${arg_title_categories_edit}     This is the second tittle, which have added for 2 minutes
${arg_cont_categories_edit}      16 years ago Seth Green decided to take his love of action figures and combine it with one of his major passions: stop-motion animation. The idea for Cartoon Network's late-night animated series "Robot Chicken" was born and the animation world suddenly changed.
${arg_expected_message}          Category saved.
